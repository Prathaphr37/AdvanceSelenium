...
public class AddClientPage2 {
	...
	//initialization
	public AddClientPage2(WebDriver driver) {
...
//	Business Libraries
	public void addClientpage(String ClientPassword,String ClientName,String ClientGender,
	...
	public void clickOnSubmitButtonToAddClient() {
		SubmitBtn.click();
	}
